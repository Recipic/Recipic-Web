...
const noticeDetailItem: NoticeDetailProps = {
  ...
  noticeId: 1,
  content:
    '안녕하세요, 회원 여러분! 최근 보이스피싱 사건이 증가함에 따라 주의를 당부드립니다. 특히, 은행이나 공공기관을 사칭하여 개인정보 및 금융정보를 요구하는 전화에 각별히 유의해주시기 바랍니다. 의심되는 전화는 바로 끊고, 해당 기관에 직접 확인하는 습관을 기르시길 바랍니다. 여러분의 안전한 정보 관리를 위해 늘 주의를 기울여 주시기를 부탁드립니다. 감사합니다.',
};
